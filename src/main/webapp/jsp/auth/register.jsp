    ...
    <form method="post" action="<%=ctx%>/register" id="registerForm" novalidate enctype="multipart/form-data" id="regForm">
      ...
      <div class="role-selector">
        <label class="role-option">
          <input type="radio" name="role" value="BUYER" id="roleBuyer" onchange="switchRole('BUYER')" required>
          <div class="role-card">
        ...
        <label class="role-option">
          <input type="radio" name="role" value="SELLER" id="roleSeller" onchange="switchRole('SELLER')">
          <div class="role-card">
