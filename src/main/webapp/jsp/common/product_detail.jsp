...
.pay-option{display:flex;align-items:center;gap:10px;padding:12px 16px;background:#fff;border:2px solid #e0e0e0;border-radius:10px;cursor:pointer;transition:all .2s}
            ...
            <div class="payment-section">
              ...
              <div class="pay-options">
                <label class="pay-option">
                  <input type="radio" name="paymentMethod" value="MTN MoMo" required onchange="showMomo('mtn')">
                  <span class="pay-icon">📱</span>
                  <span class="pay-label"><strong>MTN Mobile Money</strong><small>Receive USSD push to your phone</small></span>
                </label>
                <div class="momo-input" id="mtn-input">
                ...
                <label class="pay-option">
                  ...
                  <span class="pay-icon">📲</span>
                  <span class="pay-label"><strong>Airtel Money</strong><small>Receive USSD push to your phone</small></span>
                </label>
