...
.hero-choices { display:grid; grid-template-columns:1fr 1fr; gap:24px; margin:40px 0; max-width:800px; margin-left:auto; margin-right:auto; }
.choice-card { background:rgba(255,255,255,0.1); backdrop-filter:blur(10px); border:1px solid rgba(255,255,255,0.2); border-radius:16px; padding:32px 24px; text-align:center; transition:all 0.3s; position:relative; overflow:hidden; }
.choice-card::before { content:''; position:absolute; top:0; left:0; right:0; bottom:0; background:linear-gradient(135deg,rgba(255,255,255,0.05) 0%,transparent 100%); }
.choice-card:hover { transform:translateY(-8px); background:rgba(255,255,255,0.15); box-shadow:0 20px 40px rgba(0,0,0,0.3); }
.choice-icon { width:80px; height:80px; background:linear-gradient(135deg,var(--primary),var(--primary-dark)); border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 20px; font-size:2rem; color:#fff; box-shadow:0 8px 20px rgba(108,99,255,0.3); }
.choice-card h3 { font-size:1.4rem; font-weight:800; margin-bottom:12px; }
.choice-card p { color:rgba(255,255,255,0.8); margin-bottom:20px; font-size:0.95rem; }
.choice-features { list-style:none; margin-bottom:24px; }
.choice-features li { color:rgba(255,255,255,0.9); margin-bottom:8px; font-size:0.9rem; display:flex; align-items:center; gap:8px; }
.choice-features i { color:var(--accent); font-size:0.8rem; }
.choice-actions { display:flex; flex-direction:column; gap:12px; }
.btn-primary { background:linear-gradient(135deg,var(--primary),var(--primary-dark)); color:#fff; padding:12px 24px; border-radius:50px; text-decoration:none; font-weight:700; font-size:0.95rem; transition:all 0.2s; display:inline-block; text-align:center; }
.btn-primary:hover { transform:translateY(-2px); box-shadow:0 8px 25px rgba(108,99,255,0.4); }
.btn-secondary { background:transparent; color:#fff; border:2px solid rgba(255,255,255,0.3); padding:10px 22px; border-radius:50px; text-decoration:none; font-weight:600; font-size:0.9rem; transition:all 0.2s; display:inline-block; text-align:center; }
.btn-secondary:hover { background:rgba(255,255,255,0.1); border-color:rgba(255,255,255,0.5); }
.seller-card .choice-icon { background:linear-gradient(135deg,var(--primary),var(--primary-dark)); }
.buyer-card .choice-icon { background:linear-gradient(135deg,var(--secondary),#ff4757); }
...
.product-card.recommended { position:relative; border:2px solid #f39c12; border-radius:16px; overflow:hidden; }
.product-card.recommended:hover { border-color:#e67e22; box-shadow:0 8px 25px rgba(243,156,18,0.2); }
.recommended-badge {
...
.recommended-badge i { font-size:0.6rem; }
...
@media (max-width:768px) {
  ...
  .hero-choices { grid-template-columns:1fr; gap:16px; margin:30px 0; }
  .choice-card { padding:24px 20px; }
  .choice-icon { width:60px; height:60px; font-size:1.5rem; }
  ...
  .negotiation-actions { padding:8px; }
  
  /* Mobile video enhancements */
  .vactions { right:8px; bottom:70px; gap:12px; }
  .vact-btn { min-width:40px; }
  .vact-btn i { font-size:1.4rem; }
  .vact-btn span { font-size:0.65rem; }
  
  /* Mobile modal improvements */
  .price-modal-content { margin:20px; padding:20px; }
  
  /* Mobile section improvements */
  .section-wrap { padding:30px 15px; }
...
@media (max-width:480px) {
  ...
  .choice-icon { width:50px; height:50px; font-size:1.3rem; }
}
