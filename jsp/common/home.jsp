...
<section class="hero">
  <div class="hero-content">
    <h1>IDUKA - Rwanda's Digital Marketplace</h1>
    <p>Empowering youth entrepreneurs through digital commerce. No shop rent. No boundaries.</p>
    <div class="hero-choices">
      <div class="choice-card seller-card">
        <div class="choice-icon"><i class="fas fa-store"></i></div>
        <h3>I'm a Seller</h3>
        <p>Start your business online with zero rent costs</p>
        <ul class="choice-features">
          <li><i class="fas fa-check"></i> Free virtual shop</li>
          <li><i class="fas fa-check"></i> Reach nationwide customers</li>
          <li><i class="fas fa-check"></i> Video product promotion</li>
          <li><i class="fas fa-check"></i> Mobile money payments</li>
        </ul>
        <div class="choice-actions">
          <a href="<%=ctx%>/register?role=SELLER" class="btn-primary">Register as Seller</a>
          <a href="<%=ctx%>/login?role=SELLER" class="btn-secondary">Login as Seller</a>
        </div>
      </div>
      <div class="choice-card buyer-card">
        <div class="choice-icon"><i class="fas fa-shopping-cart"></i></div>
        <h3>I'm a Buyer</h3>
        <p>Shop from local businesses across Rwanda</p>
        <ul class="choice-features">
          <li><i class="fas fa-check"></i> Wide product selection</li>
          <li><i class="fas fa-check"></i> Direct chat with sellers</li>
          <li><i class="fas fa-check"></i> Secure mobile payments</li>
          <li><i class="fas fa-check"></i> Home delivery</li>
        </ul>
        <div class="choice-actions">
          <a href="<%=ctx%>/register?role=BUYER" class="btn-primary">Register as Buyer</a>
          <a href="<%=ctx%>/login?role=BUYER" class="btn-secondary">Login as Buyer</a>
        </div>
      </div>
    </div>
  </div>
  <div class="hero-stats">
    ...
    <div class="stat"><i class="fas fa-video"></i><strong>1000+</strong><span>Product Videos</span></div>
  </div>
</section>
</c:if>
...
<section class="section-wrap">
  <div class="section-header">
    <h2 class="section-title"><i class="fas fa-star" style="color: #f39c12;"></i> Recommended for You</h2>
    <a href="<%=ctx%>/home" class="btn-outline-sm">View All</a>
  </div>
  <div class="products-grid">
    <c:forEach var="product" items="${recommendedProducts}" begin="0" end="5">
